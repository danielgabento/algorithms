...
A = int(input("Informe o primeiro lado de um triângulo (A): "))
B = int(input("Informe o segundo lado de um triângulo (B): "))
C = int(input("Informe o terceiro lado de um triângulo (C): "))
